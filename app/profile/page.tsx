...
export default function Profile() {
  ...
  async function solicitarRemocaoDados() {
    if (!confirm('Tem certeza que deseja solicitar a remoção de seus dados? Esta ação não pode ser desfeita.')) {
      return
    }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <motion.div
                  animate={{ rotate: user.acesso_bunker ? 0 : 45 }}
                  className="text-2xl"
                >
                  {user.acesso_bunker ? '🔓' : '🔒'}
                </motion.div>
        ...
        <section className="bg-gray-900 p-6 rounded border border-green-500">
          ...
          <div className="space-y-4">
            {desafios.filter(d => !d.concluido).map(desafio => (
              <motion.div
                key={desafio.id}
              ...
              >
                <div className="flex items-center gap-3">
                  <input
                    ...
                    onChange={() => {/* Implementar conclusão */}}
